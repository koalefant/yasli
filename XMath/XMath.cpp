...
void Mat2f::serialize(yasli::Archive& ar)
{
    ar(*(Vect2f*)&xx, "", "&xrow");
    ar(*(Vect2f*)&yx, "", "&yrow");
}
...
void Vect3d::serialize(yasli::Archive& ar) 
{
	ar(x, "", "^x");
	ar(y, "", "^y");
	ar(z, "", "^z");
...
void Mat3f::serialize(yasli::Archive& ar) 
{
	ar(xrow(), "", "xrow");
	ar(yrow(), "", "yrow");
	ar(zrow(), "", "zrow");
...
void Mat3d::serialize(yasli::Archive& ar) 
{
	ar(xrow(), "", "xrow");
	ar(yrow(), "", "yrow");
	ar(zrow(), "", "zrow");
...
void MatXf::serialize(yasli::Archive& ar) 
{
	ar(rot(), "", "Orientation");
	ar(trans(), "", "Position");
}

void MatXd::serialize(yasli::Archive& ar) 
{
	ar(rot(), "", "Orientation");
	ar(trans(), "", "Position");
}

void MatX2f::serialize(yasli::Archive& ar)
{
    ar(rot, "", "Orientation");
    ar(trans, "", "Position");
}
