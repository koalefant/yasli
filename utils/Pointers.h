...
/// smart pointer с интрузивным подсчетом ссылок (T должен быть производным от RefCounter)
template<class T>
...
/// Автоматический указатель а-ля std::auto_ptr
template<class T>
class AutoPtr{
public:
    AutoPtr()
